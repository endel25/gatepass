...
<section class="content-header">
   <div class="mb-5 flex items-center justify-between">
      ...
      <a type="button" href="{{ route('userroles.create') }}" class="btn btn-sm btn-l btn-primary rounded-full">Add Userrole</a>
   ...
   <div class="panel">
      <table id="myTable" class="table-hover whitespace-nowrap">
         ...
         <tbody>
            ...
            <tr>
               <td>{{$userroles->UserRoleName}}</td>
               <td>
                  <div class="flex items-center  gap-4" >
                     <a href="{{ route('userroles.edit',$userroles->id) }}" title="EDIT">
                    ...
                    <a onclick="showAlert('{{URL::to('/')}}/userroles/{{ $userroles->id }}/delete')"  title="DELETE">

...
<html lang="en" dir="ltr">
    <head>
        ...
        <title>@if($__env->yieldContent('Title') == '')Cloud-Gatepass @else @yield('Title') @endif</title>
                    ...
                    <div class="h-full bg-white dark:bg-[#0e1726]">
                        <div class="flex items-center justify-between px-4 py-3">
                            <a href="index.html" class="main-logo flex shrink-0 items-center">
                                <img class="ml-[5px] w-8 flex-none" src="{{ asset('assets/images/icon.png')}}" alt="image" />
                        ...
                        >
                            ...
                            <li class="nav-item">
                                <ul>
                                   ...
                                   <!-- Product -->
                                    ...
                                    <!-- Driver -->
                                    <li class="nav-item">
                                        <a href="{{ route('drivers.index') }}" class="group">
                                            <div class="flex items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                     ...
                                     <!-- Transpoter -->
                                    <li class="nav-item">
                                        <a href="{{ route('transporter.index') }}" class="group">
                                            <div class="flex items-center">
                                               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                            ...
                            <!-- User Role -->
                            <li class="menu nav-item">
                                <a href="{{ route('userroles.index') }}" class="nav-link group">
                                    <div class="flex items-center">
                                        <div class="flex items-center">
                            ...
                            <!--App Directory -->
                            <li class="menu nav-item">
                                <a href="{{ route('appdirectory.index') }}" class="nav-link group">
                                    <div class="flex items-center">
                                        <div class="flex items-center">
                                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                             width="512.000000pt" height="512.000000pt" viewBox="0 0 512.000000 512.000000"
                    ...
                    <div class="shadow-sm">
                        <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                                ...
                                <a href="index.html" class="main-logo flex shrink-0 items-center">
                                    <img class="inline w-8 ltr:-ml-3 rtl:-mr-1" src="{{ asset('assets/images/icon.png')}}" alt="image" />
                                    ...
                                    <a href="javascript:;" class="group relative" @click="toggle()">
                                        <span
                                            ><img
                                                ...
                                                src="{{ asset('assets/images/auth/user.png') }}"
                                                alt="image"
                                        /></span>
                                    </a>
                                    <ul
                                    ...
                                    >
                                        <li>
                                            <div class="flex items-center px-4 py-4">
                                                <div class="flex-none">
                                                    <img class="h-10 w-10 rounded-md object-cover" src="{{ asset('assets/images/auth/user.png') }}" alt="image" />
                                                </div>

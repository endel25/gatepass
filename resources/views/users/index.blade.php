...
<section class="content-header">
   <div class="mb-5 flex items-center justify-between">
      ...
      <a type="button" href="{{ route('users.create') }}" class="btn btn-sm btn-l btn-primary rounded-full">Add User</a>
            ...
            <tr>
               ...
               <td style="text-align-last: center;">
                  <label class="relative h-6 w-12">
                     <input
                         ...
                         {{ ($user->Active!=0)? "checked" : "" }} onclick="Active({{$user->id}})"
                     />
                     <span
               ...
               <td>
                  <div class="flex items-center  gap-4" >
                    ...
                    <a onclick="showAlert('{{URL::to('/')}}/users/{{ $user->id }}/delete')"  title="DELETE">

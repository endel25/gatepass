...
<section class="content-header">
   <div class="mb-5 flex items-center justify-between">
      <h5 class="text-lg font-semibold dark:text-white-light">Vehicle Management Stack</h5>

      <a type="button" href="{{ route('vehicles.create') }}" class="btn btn-sm btn-l btn-primary rounded-full">Add Vehicle</a>
            ...
            <tr>
               ...
               <td style="text-align-last: center;">
                  <label class="relative h-6 w-12">
                     <input
                         ...
                         {{ ($vehicle->IsActive!=0)? "checked" : "" }} onclick="Active({{$vehicle->id}})"
                     />
                     <span
               ...
               <td>
                  <div class="flex items-center  gap-4" >
                    ...
                    <a onclick="showAlert('{{URL::to('/')}}/vehicles/{{ $vehicle->id }}/delete')"  title="DELETE">
      ...
      if (id != "") 
      {
         $.ajax({
            ...
            success: function(response){
               ...
               {
                  showMessage('Vehicle Active','success')
               }
               else{
                  showMessage('Vehicle Deactive','success')

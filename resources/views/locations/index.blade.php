...
<section class="content-header">
   <div class="mb-5 flex items-center justify-between">
      <h5 class="text-lg font-semibold dark:text-white-light">Location Management Stack</h5>
      <a type="button" href="{{ route('locations.create') }}" class="btn btn-sm btn-l btn-primary rounded-full">Add Location</a>
   </div>
</section>
<section>
   <div class="panel">
            ...
            <tr>
               ...
               <td>
                  <div class="flex items-center  gap-4" >
                    ...
                    <a onclick="showAlert('{{URL::to('/')}}/locations/{{ $location->id }}/delete')" title="DELETE">

...
<section class="content">
  <div class="panel">
    <form  class="space-y-2" id="myForm" action="{{ route('gatepass.store') }}" method="POST">
      @csrf
          ...
          <div class="webcam-container">
            <div class="webcam-wrapper">
              <div id="webcam1" class="webcam-feed">
                <img src="{{asset('dist/img/webcam.png')}}" width="320" id='driverphoto'>
              </div>
          ...
          <div class="webcam-container">
            <div class="webcam-wrapper">
              <div id="webcam2" class="webcam-feed">
                <img src="{{asset('dist/img/webcam.png')}}" width="320"  id="licencephoto">
              </div>

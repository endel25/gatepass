...
<section class="content-header">
   <div class="mb-5 flex items-center justify-between">
      ...
      <a type="button" href="{{ route('products.create') }}" class="btn btn-sm btn-l btn-primary rounded-full">Add Product</a>
   </div>
</section>
<section>
   <div class="panel">
            ...
            <tr>
               ...
               <td style="text-align-last: center;">
                <label class="relative h-6 w-12">
                   <input
                       ...
                       {{ ($product->IsActive!=0)? "checked" : "" }} onclick="Active({{$product->id}})"
                   />
                   <span
               ...
               <td>
                  <div class="flex items-center  gap-4" >
                    ...
                    <a onclick="showAlert('{{URL::to('/')}}/products/{{ $product->id }}/delete')" title="DELETE">

...
<section class="content" >
		...
		<div class="panel">
			<form class="space-y-5" id="myForm" action="{{ route('products.store') }}" method="POST">
				@csrf
			    <div class="flex sm:flex-row flex-col" id="ProductTypeField">
				    ...
				    <option {{$ptypes->FieldValue == old('ProductType')?'selected':''}} value="{{$ptypes->FieldValue}}">{{$ptypes->FieldValue}}</option>
				    @endforeach
				</select>
			    </div>
			    <div class="flex sm:flex-row flex-col" id="ProductNameField">
				    ...
				    <input type="text" placeholder="Enter Product Name" class="text-xs form-input flex-1" name="ProductName" id="ProductName" value="{{old('ProductName')}}" >

				</div>
			    <div class="flex sm:flex-row flex-col" id="ProductCodeField">
			        <label  class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Product Code</label>
			        <input type="text" placeholder="Enter Product Code" class="text-xs form-input flex-1" name="ProductCode" id="ProductCode" value="{{old('ProductCode')}}">
			    </div>
			    <div class="flex sm:flex-row flex-col" id="ProductUnitField">
			        <label  class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Product Unit</label>
			        <input type="text" placeholder="Enter Product Unit" class="text-xs form-input flex-1" name="ProductUnit" id="ProductUnit" value="{{old('ProductUnit')}}">
			    </div>
			    <div class="flex sm:flex-row flex-col">
			        <label  class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Product Price</label>
			        <input type="text" x-mask="9999999" placeholder="Enter Product Price" class="text-xs form-input flex-1" name="ProductPrice" id="ProductPrice" value="{{old('ProductPrice')}}">
			    </div>
			    <div class="flex sm:flex-row flex-col">
			        <label  class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Theoratical Weight</label>
			        <input type="text" x-mask="9999999" placeholder="Enter Theoratical Weight" class="text-xs form-input flex-1" name="TheoraticalWeight" id="TheoraticalWeight" value="{{old('TheoraticalWeight')}}">
			    </div>
			    <div class="flex sm:flex-row flex-col">

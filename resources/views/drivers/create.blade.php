...
<section class="content">
  <div class="panel">
    <form class="space-y-2" id="myForm" action="{{ route('drivers.store') }}" method="POST">
      @csrf
      <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
        ...
        <div class="flex-1 max-w-lg space-y-3">
          <div class="flex sm:flex-row flex-col" id="PersonTypeField">
            ...
            <select id="PersonType" name="PersonType" class="form-input-sm  form-input">
          ...
          <div class="flex sm:flex-row flex-col" id="FirstNameField">
            ...
            <input type="text" placeholder="Enter First Name" class="form-input form-input-sm flex-auto" name="FirstName" id="FirstName" value="{{old('FirstName')}}">
          </div>
          <div class="flex sm:flex-row flex-col" id="LastNameField">
            ...
            <input type="text" placeholder="Enter Last Name" class=" form-input form-input-sm flex-auto" name="LastName" id="LastName" value="{{old('LastName')}}">
          </div>
          <div class="flex sm:flex-row flex-col" id="LicenseNoField">
            ...
            <input type="text" placeholder="Enter National Id" class="form-input form-input-sm flex-auto" name="LicenseNo" id="LicenseNo" value="{{old('LicenseNo')}}" oninput="this.value = this.value.toUpperCase()">
          </div>
          <div class="flex sm:flex-row flex-col" id="ContactNoField">
            ...
            <input type="text" placeholder="Enter Contact No." class="form-input form-input-sm flex-auto" name="ContactNo" id="ContactNo" value="{{old('ContactNo')}}" x-mask='999-9999999'>
          </div>
          <div class="flex sm:flex-row flex-col">
            <label class="mb-0 sm:w-1/2 sm:ltr:mr-2 rtl:ml-2">Notes</label>
            <textarea class="form-input-sm flex-auto form-input" name="Notes"></textarea>
          </div>
        </div>

...
<section class="content-header">
   <div class="mb-5 flex items-center justify-between">
      ...
      <a type="button" href="<?php echo e(route('drivers.create')); ?>" class="btn btn-sm btn-l btn-primary rounded-full">Add Driver / Visitor</a>
      ...
      <table id="myTable" class="table-hover whitespace-nowrap">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td><?php echo e($driver->PersonType); ?></td>
               ...
               <td style="text-align-last: center;">
                  <label class="relative h-6 w-12">
                     <input
                         ...
                         <?php echo e($driver->Blacklist!=0 ? "checked" : ""); ?> onclick="Blacklist(<?php echo e($driver->id); ?>)" <?php echo e($driver->Active==1? "disabled" : ""); ?> 
                     />
                     <span
               ...
               <td style="text-align-last: center;">
                  <label class="relative h-6 w-12">
                     <input
                         ...
                         class="custom_switch peer absolute z-10 h-full w-full cursor-pointer opacity-0"
                         id="custom_switch_checkbox2"
                         <?php echo e(($driver->Active!=0)? "checked" : ""); ?> <?php echo e(($driver->Blacklist==1)? "disabled" : ""); ?> onclick="Active(<?php echo e($driver->id); ?>)"
                     />
                     <span
                         for="custom_switch_checkbox2"
                         class="outline_checkbox bg-icon block h-full rounded-full border-2 border-[#ebedf2] before:absolute before:bottom-1 before:left-1 before:h-4 before:w-4 before:rounded-full before:bg-[#ebedf2] before:bg-[url('../images/close.svg')] before:bg-center before:bg-no-repeat before:transition-all before:duration-300 peer-checked:border-primary peer-checked:before:left-7 peer-checked:before:bg-primary peer-checked:before:bg-[url('../images/checked.svg')] dark:border-white-dark dark:before:bg-white-dark"
               ...
               <td>
                  <div class="flex items-center  gap-4" >
                     <a href="<?php echo e(route('drivers.edit',$driver->id)); ?>" title="EDIT">
                    ...
                    <a onclick="showAlert('<?php echo e(URL::to('/')); ?>/drivers/<?php echo e($driver->id); ?>/delete')"  title="DELETE">
...
<script type="text/javascript">
   ...
   function Blacklist(id) 
   {
      ...
      if (id != "") 
      {
         $.ajax({
            type: 'POST',
            url: "<?php echo e(URL::to('/')); ?>/Active_Blacklist",
            cache: false,
            data: {                     
               id: id,
               _token: _token
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\cloud-gatepass\resources\views/drivers/index.blade.php ENDPATH**/ ?>
...
<section class="content-header">
   <div class="mb-5 flex items-center justify-between">
      <h5 class="text-lg font-semibold dark:text-white-light">Userrole Management Stack</h5>

      <a type="button" href="<?php echo e(route('userroles.create')); ?>" class="btn btn-sm btn-l btn-primary rounded-full">Add Userrole</a>
            ...
            <tr>
               ...
               <td>
                  <div class="flex items-center  gap-4" >
                     <a href="<?php echo e(route('userroles.edit',$userroles->id)); ?>" title="EDIT">
                    ...
                    <a onclick="showAlert('<?php echo e(URL::to('/')); ?>/userroles/<?php echo e($userroles->id); ?>/delete')"  title="DELETE">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\cloud-gatepass\resources\views/userroles/index.blade.php ENDPATH**/ ?>
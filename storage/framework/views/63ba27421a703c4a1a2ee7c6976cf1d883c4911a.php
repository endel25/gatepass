...
<section class="content-header">
   <div class="mb-5 flex items-center justify-between">
      <h5 class="text-lg font-semibold dark:text-white-light">Product Management Stack</h5>
      <a type="button" href="<?php echo e(route('products.create')); ?>" class="btn btn-sm btn-l btn-primary rounded-full">Add Product</a>
   </div>
</section>
<section>
   <div class="panel">
            ...
            <tr>
               ...
               <td style="text-align-last: center;">
                <label class="relative h-6 w-12">
                   <input
                       ...
                       <?php echo e(($product->IsActive!=0)? "checked" : ""); ?> onclick="Active(<?php echo e($product->id); ?>)"
                   />
                   <span
               ...
               <td>
                  <div class="flex items-center  gap-4" >
                     <a href="<?php echo e(route('products.edit',$product->id)); ?>" title="EDIT">
                    ...
                    <a onclick="showAlert('<?php echo e(URL::to('/')); ?>/products/<?php echo e($product->id); ?>/delete')" title="DELETE">
...
function Active(id)
   {
      ...
      if (id != "")
      {
         $.ajax({
            type: 'POST',
            url: "<?php echo e(URL::to('/')); ?>/Active_Product",
            cache: false,
            data: {
               id: id,
               _token: _token
            ...
            success: function(response){
               ...
               {
                  showMessage('Product Active','success')
               }
               else{
                  showMessage('Product Deactive','success')
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\cloud-gatepass\resources\views/products/index.blade.php ENDPATH**/ ?>
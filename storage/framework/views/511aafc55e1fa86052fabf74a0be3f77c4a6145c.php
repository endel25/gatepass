...
<section class="content-header">
   <div class="mb-5 flex items-center justify-between">
      <h5 class="text-lg font-semibold dark:text-white-light">User Management Stack</h5>

      <a type="button" href="<?php echo e(route('users.create')); ?>" class="btn btn-sm btn-l btn-primary rounded-full">Add User</a>
            ...
            <tr>
               ...
               <td style="text-align-last: center;">
                  <label class="relative h-6 w-12">
                     <input
                         ...
                         <?php echo e(($user->Active!=0)? "checked" : ""); ?> onclick="Active(<?php echo e($user->id); ?>)"
                     />
                     <span
               ...
               <td>
                  <div class="flex items-center  gap-4" >
                     <a href="<?php echo e(route('users.edit',$user->id)); ?>" title="EDIT">
                    ...
                    <a onclick="showAlert('<?php echo e(URL::to('/')); ?>/users/<?php echo e($user->id); ?>/delete')"  title="DELETE">
...
<script type="text/javascript">
   ...
   function Active(id) 
   {
      ...
      if (id != "") 
      {
         $.ajax({
            type: 'POST',
            url: "<?php echo e(URL::to('/')); ?>/Active_User",
            cache: false,
            data: {                     
               id: id,
               _token: _token
            ...
            success: function(response){
               ...
               {
                  showMessage('User Active','success')
               }
               else{
                  showMessage('User Deactive','success')
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\cloud-gatepass\resources\views/users/index.blade.php ENDPATH**/ ?>
...
<html lang="en" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('assets/css/highlight.min.css')); ?>" />
        <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;500;600;700;800&display=swap" rel="stylesheet" />
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="mx-auto w-full max-w-[400px]">
                                <img class="w-52" style="margin-left: 3.3rem;"  src="<?php echo e(asset('assets/images/logo_.png')); ?>" alt="image" />
                                <form class="space-y-5 dark:text-white" action="<?php echo e(route('login')); ?>" method="POST">
                                  <?php echo csrf_field(); ?>
                                    <div>
                                    ...
                                    <?php if($message = Session::get('message')): ?>
                                            <div class="alert alert-danger" style="margin-left: 70%; display:none;">
                                                <p id="error"><?php echo e($message); ?></p>
                                            </div>
                                    <?php endif; ?>
                                </form>
